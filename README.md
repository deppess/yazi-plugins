...
| [restore.yazi](restore.yazi) | Restore deleted files/folders with quick recovery or a native picker. Fork of [boydaihungst/restore.yazi](https://github.com/boydaihungst/restore.yazi). |
